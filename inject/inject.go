...
func Inject() {
	...
	summoner.Given[service.Parser[model.LispExpr]](&LispParser{})
...
func (parser *LispParser) Parse(s string) result.Result[model.LispExpr] {
	return result.FromErr[model.LispExpr](fmt.Errorf("unimplemented"))
}
